...
class ArgsParser(ArgumentParser):
    def __init__(self):
        ...
        self.add_argument("-c", "--config", help="configuration file to use",default="../configs/mot/fairmot/fairmot_dla34_30e_1088x608.yml")  # ckpt
        self.add_argument(
            "-o", "--opt", nargs='*', help="set configuration options",
            default=["weights=https://paddledet.bj.bcebos.com/models/mot/fairmot_dla34_30e_1088x608.pdparams"]
        )
